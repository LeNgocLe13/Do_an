...
?>
  ...
  <section class="home-section">
    <div class="menu_editing">
      <h1><?= !empty($_GET['id']) ?  "Sửa danh mục" : "Thêm danh mục" ?></h1>
      <div id="menu_editing-content-box">
        <?php
        ...
        ?>
          <form id="editing-form-menu-editing" method="POST" action="<?= !empty($currentMenu) ? "?action=edit&id=" . $_GET['id'] : "?action=add" ?>" enctype="multipart/form-data">
            <input type="submit" title="Lưu danh mục" value="" />
            <div class="clear-both"></div>
            <div class="wrap-field-menu-editing">
