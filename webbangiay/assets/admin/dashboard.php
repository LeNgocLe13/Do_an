...
?>
    ...
    <section class="home-section">
        <main class="main">
            <marquee>Nhóm 3: Mai Đức Long, Lê Ngọc Lê, Trương Văn Dương, Lâm Xuân Đông</marquee>
            <div class="main-header">
                <div class="main-header__intro-wrapper">
                    <div class="main-header__welcome">
                        <div class="main-header__welcome-title text-light">Xin chào, <strong><?= $currentUser['fullname'] ?></strong></div>
                        <div class="main-header__welcome-subtitle text-light">Chúc bạn có một ngày tốt lành</div>
                    </div>
                    <div class="quickview">
                        <div class="section">
                            <!-- <div class="container">
