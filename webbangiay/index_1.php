...
<head>
    ...
    <link rel="stylesheet" href="./assets/resources/library/fancybox/fancybox/jquery.fancybox.min.css" />
...
<body>
            ...
            ?>
                <div class="product-item">
                    <div class="product-img">
                        <a href="detail.php?id=<?= $row['id'] ?>"><img src="./assets/<?= $row['image'] ?>" title="<?= $row['name'] ?>" /></a>
                    </div>
    ...
    <div id="cart-icon">
        <a data-fancybox data-type="ajax" data-src="ajax-cart.php" href="javascript:;">
            <img width="100" src="./assets/resources/images/cart.png" alt="alt" />
        </a>
    </div>
