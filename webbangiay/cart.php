...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./assets/resources/css/cart.css">
                ...
                if (isset($_POST['update_click'])) { //Cập nhật số lượng sản phẩm
                    ...
                    if ($error == false && !empty($_POST['quantity'])) { //Xử lý lưu giỏ hàng vào db
                        ...
                        if ($GLOBALS['changed_cart'] == false) {
                            ...
                            $insertOrder = mysqli_query($con, "INSERT INTO `orders` (`id`, `name`, `phone`,`mail`, `address`, `note`, `total`, `created_time`, `last_updated`) VALUES (NULL, '" . $_POST['name'] . "', '" . $_POST['phone'] . "', '" . $_POST['mail'] . "', '" . $_POST['address'] . "', '" . $_POST['note'] . "', '" . $total . "', '" . time() . "', '" . time() . "');");
        ...
        <?php } else { ?>
            ...
            <?php } else { ?>
                <form id="cart-form" action="cart.php?action=submit" method="POST">
                    ...
                    <div><label>Điện thoại: </label><input type="number" value="" name="phone" /></div>
                    <div><label>Email: </label><input type="email" value="" name="mail" required="" /></div>
